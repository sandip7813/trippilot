...
const steps = [
    {
        ...
        description:
            'Share destination, dates, budget, and travel style in plain language.',
    },
    {
        step: '02',
        title: 'AI builds your plan',
        description:
            'Gemini crafts a day-by-day itinerary with activities, meals, and tips.',
    },
    {
        step: '03',
        title: 'Refine & go',
        description:
            'Adjust with the chat assistant, check weather, and hit the road.',
    },
];
...
const features = [
    {
        ...
        text: 'Personalized plans in seconds',
    },
    {
        icon: Map,
        title: 'Interactive maps',
        text: 'Geoapify-powered exploration',
    },
    {
        icon: Route,
        title: 'Road trip routes',
        text: 'Stops, timing, and scenic drives',
    },
...
<template>
    ...
    <div class="min-h-screen bg-background text-foreground">
        ...
        <section class="relative min-h-[92vh] overflow-hidden">
            ...
            <!-- Hero content -->
            <div
                class="relative z-10 mx-auto flex min-h-[calc(92vh-5rem)] max-w-7xl flex-col justify-center px-6 pt-8 pb-16 lg:px-8"
            >
                <div class="max-w-2xl">
                    <div
                    ...
                    <h1
                        class="text-4xl leading-[1.1] font-extrabold tracking-tight text-balance text-white sm:text-5xl lg:text-6xl xl:text-7xl"
                    >
                        Your next adventure,
                        <span
                    ...
                    <p
                        class="mt-6 max-w-xl text-lg leading-relaxed text-pretty text-white/80 sm:text-xl"
                    >
                        From weekend getaways to cross-country road trips —
                        TripPilot turns your ideas into beautiful itineraries
                        with AI, maps, and live weather.
                    </p>
                    <div
                    ...
                    <!-- Trust strip -->
                    <div
                        class="mt-12 flex flex-wrap gap-6 border-t border-white/15 pt-8"
                    >
                        <div
                            v-for="stat in stats"
                            :key="stat.label"
            ...
            <div class="absolute bottom-6 left-1/2 z-10 -translate-x-1/2">
                <div class="flex flex-col items-center gap-1 text-white/50">
                    ...
                    >
                    <div
                        class="h-8 w-px animate-pulse bg-gradient-to-b from-white/50 to-transparent"
                    />
                </div>
            </div>
        </section>
                ...
                <div class="mx-auto mb-14 max-w-2xl text-center">
                    ...
                    >
                        <span class="brand-gradient-text"
                            >Where will you go next?</span
                        >
                    </h2>
                    <p class="mt-4 text-muted-foreground">
                        Whether it's ancient cities, open highways, or hidden
                        beaches — plan every detail before you pack.
                    </p>
                </div>
        ...
        <!-- ═══ HOW IT WORKS ═══ -->
        <section
            class="border-y border-border/60 bg-gradient-to-br from-teal-500/5 via-violet-500/5 to-orange-500/5 py-24"
        >
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="grid items-center gap-16 lg:grid-cols-2">
                    ...
                    >
                        ...
                        >
                            <p
                                class="text-xs font-medium tracking-wider text-teal-300 uppercase"
                            >
                                Powered by AI
                            </p>
        ...
        <section class="px-6 pb-24 lg:px-8">
            ...
            >
                ...
                />
                <div
                    class="absolute inset-0 bg-gradient-to-r from-teal-950/90 via-teal-900/75 to-teal-950/60"
                />
                <div class="relative px-8 py-20 text-center md:px-16 md:py-24">
                    ...
                    <p class="mx-auto mt-4 max-w-lg text-lg text-white/80">
                        Join TripPilot and turn your travel dreams into
                        detailed, actionable plans — completely free to get
                        started.
                    </p>
                    <div
            ...
            <div class="mx-auto max-w-7xl px-6 py-12 lg:px-8">
                ...
                >
                    ...
                    <p class="text-sm text-muted-foreground">
                        &copy; {{ new Date().getFullYear() }} TripPilot. All
                        rights reserved.
                    </p>
                </div>
            </div>
